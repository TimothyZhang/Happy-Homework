...
module.exports = {
  en: {
    ...
    pet_xp_rule_idle: 'EXP grows on its own over time — the happier, fuller, cleaner, healthier your pet is and the more effort it puts in, the faster it grows (up to 10/hour when every stat is full).',
